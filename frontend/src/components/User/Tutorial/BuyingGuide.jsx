    ...
    <div className="container">
      <div className="row">
        <div className="content-page tutorial-content">
          ...
          <p>
            (Trong trường hợp các bạn mua nhiều sản phẩm, các bạn thêm từng sản
            phẩm vào giỏ hàng, sau khi&nbsp;đã&nbsp;đủ sản phẩm và số lượng ,
            các bạn vui lòng kiểm tra thật kỹ giỏ hàng và&nbsp;ấn THANH TOÁN)
          </p>
          <p>
          ...
          <p>
            ...
            <strong>:</strong>&nbsp;Thanh toán khi nhận hàng tại nhà&nbsp;(COD –
