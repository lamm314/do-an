      ...
      <div className="row">
        <div className="content-page tutorial-content">
          ...
          <p>
            ...
            trả lại hàng trong 3 ngày tính tại thời&nbsp;&nbsp;điểm nhận
          ...
          <p>
            - Không đủ số lượng, không đủ bộ như trong đơn hàng. ( Khi nhận hàng
            các bạn sẽ&nbsp;được kiểm tra trước khi nhận, các bạn có quyền không
            nhận hàng khi không&nbsp;đủ số lượng hoặc sai mẫu. Các trường
            hợp&nbsp;đã nhận hàng xong Shop sẽ không giải quyết)
          </p>
          <p>
            Nếu trong trường hợp các bạn&nbsp;đã nhận hàng nhưng&nbsp;đặt nhầm
            Size:
          </p>
          <p>
