      ...
      <div className="test_t">
        <div className="Moment">
          <div className="product-title-container">
            <Link to="/" className="col-xl-12 product-title">
              Sản phẩm mới
            </Link>
            <p className="col-xl-12 product-title-description">
              Sản phẩm mới nhất của KITTY
            </p>
          </div>
          <Slider {...settings}>
            {products &&
                ...
                return (
                  product.new_product && (
                    <Link
                      ...
                      className="col-xl-3 item testt"
                    >
                      <div
                        className="product-img"
                        style={{
                          backgroundImage: `url('/images/${product.product_avatar}')`,
                        }}
                      ></div>
        ...
        <div className="Sale">
          <div className="product-title-container">
            <Link to="/products/sale" className="col-xl-12 product-title">
              Đang giảm giá
            </Link>
            <p className="col-xl-12 product-title-description">
              Sản phẩm chỉ còn một vài Size và không được sản xuất lại sau khi
              bán hết
            </p>
          </div>
          <Slider {...settings}>
