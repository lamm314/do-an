  ...
  return (
      <div className="container-center-horizontal">
        <div className="u355u95cua-hang screen " data-id="1:39">
          ...
          <div className="c-d6kwVs inter-extra-bold-fire-bush-30px" data-id="1:41">
            C
          </div>
          <div className="text_label-d6kwVs text_label inter-extra-bold-fire-bush-30px" data-id="1:42">
            Á
          </div>
          <div className="h-d6kwVs inter-extra-bold-fire-bush-30px" data-id="1:43">
            H
          </div>
          <div className="text_label-52vd8y text_label inter-extra-bold-fire-bush-30px" data-id="1:44">
            Ọ
          </div>
          <div className="a-d6kwVs inter-extra-bold-fire-bush-30px" data-id="1:45">
            A
          </div>
          <img className="shopping-cart-d6kwVs" data-id="1:46" src="/img/shopping-cart@2x.png" alt="Shopping Cart" />
          <img className="menu-d6kwVs" data-id="1:47" src="/img/menu.svg" alt="Menu" />
          <div className="frame-ca-hng-d6kwVs" data-id="1:50">
            ...
            <img className="rectangle-109-l3EI9M" data-id="1:52" src="/img/rectangle-109.svg" alt="Rectangle 109" />
            <img className="rectangle-110-l3EI9M" data-id="1:53" src="/img/rectangle-110.svg" alt="Rectangle 110" />
            <img className="rectangle-111-l3EI9M" data-id="1:54" src="/img/rectangle-111.svg" alt="Rectangle 111" />
            <img className="rectangle-112-l3EI9M" data-id="1:55" src="/img/rectangle-112.svg" alt="Rectangle 112" />
