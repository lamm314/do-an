    ...
    <div className="container details">
        ...
        <div className="img-show-details">
                ...
                return (
                  <li className="product-img" key={index}>
                    <div
                      className="img-"
                      id="choice1"
                      onClick={() => goto(index, "choice1")}
                    >
                      <img
                        alt=" Signature Tee - White 1 "
                        src={`/images/${image}`}
                      ></img>
                    </div>
                  </li>
          ...
          <div className="Product-details-img">
            <Slide ref={slideRef} {...properties}>
              ...
              {image_array?.map((image, index) => {
                return (
                  <div key={index} onClick={() => changeOn(index, true)}>
                    <img
            ...
            {isOpen && (
              <Lightbox
                ...
                nextSrc={`/images/${
                  image_array[(photoIndex + 1) % image_array.length]
                }`}
                prevSrc={`/images/${
                  image_array[
                    (photoIndex + image_array.length - 1) % image_array.length
                  ]
                }`}
                ...
                onMoveNextRequest={() =>
                  setPhotoIndex((photoIndex + 1) % image_array.length)
                }
              />
            )}
          </div>
      ...
      <div className="ProductDetail-content">
        ...
        <div className="Product-price">
          {product.discount ? (
            <span className="Pro-sale">{product.discount}%</span>
          ) : (
            <></>
          )}
        ...
        <div className="bar_selector">
          ...
          <div className="add-to-cart">
            <button className="button-add" onClick={() => handleAddToCard()}>
              Thêm vào giỏ
            </button>
          </div>
        </div>
        ...
        <div className="Full-Infor">
          <section className="Pro-details">
            <ul className="task-bar">
              <li className="li_cs">
                <div className="con" onClick={() => test1()}>
                  Chính sách đổi trả hàng{" "}
                </div>
              </li>

              <li className="li_cs">
                <div className="con" onClick={() => test2()}>
                  {" "}
                  Hướng dẫn mua hàng
                </div>
              </li>
              ...
              {check ? (
                <div className="test" id="">
                  ...
                  <div className="detailsnote">
                    ...
                    <p className="noname1">
                      ...
                      đổi hàng/ trả lại hàng trong 3 ngày tính tại thời điểm
                      nhận hàng&nbsp;trong những trường hợp sau:
                    </p>
                    <ul>
                      <li>
                        Hàng không đúng chủng loại, mẫu mã trong đơn hàng đã đặt
                        hoặc như trên website tại thời điểm đặt hàng.<br></br>
                      </li>
                    </ul>
                    <p>
                      <br></br>
                    ...
                    <ul>
                      <li>
                        Không đủ số lượng, không đủ bộ như trong đơn hàng. ( Khi
                        nhận hàng các bạn sẽ&nbsp;được kiểm tra trước khi nhận,
                        các bạn có quyền không nhận hàng khi không&nbsp;đủ số
                        lượng hoặc sai mẫu. Các trường hợp&nbsp;đã nhận hàng
                        xong Shop sẽ không giải quyết)
                      </li>
                    </ul>
                    <br></br>
                    <p className="noname1">
                      Nếu trong trường hợp các bạn&nbsp;đã nhận hàng
                    ...
                    <p>
                      <strong>
                        <br />
                        <p className="title2">- Sản phẩm được đổi là khi :</p>
                      </strong>
                    </p>
                ...
                <div className="test" id="">
                  ...
                  <div className="detailsnote">
                    ...
                    <br />
                    <p>
                      + Chọn sản phẩm -&gt; chọn Size sản phẩm -&gt; thêm vào
                      giỏ hàng -&gt; thanh toán
                    </p>
                    <p>
                      (Trong trường hợp các bạn mua nhiều sản phẩm, các bạn thêm
                      từng sản phẩm vào giỏ hàng, sau khi&nbsp;đã&nbsp;đủ sản
                      phẩm và số lượng , các bạn vui lòng kiểm tra thật kỹ giỏ
                      hàng và&nbsp;ấn THANH TOÁN)
                    </p>
                    <br></br>
                    <p>
                    ...
                    <p>
                      <span className="wysiwyg-font-size-medium noname2">
                        <strong>
                          <u className="title2">Cách 1</u>
                        </strong>
                        <strong>:</strong>&nbsp;Thanh toán khi nhận hàng tại
                        nhà&nbsp;(COD – giao hàng và thu tiền tận nơi)
                      </span>
                    </p>
                    <p>
                      <span className="wysiwyg-font-size-medium">
