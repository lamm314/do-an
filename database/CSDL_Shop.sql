...
create table users(
	...
	user_name varchar(200) character set utf8 default 'unknown' not null,
	email varchar(40) default 'unknown'not null unique,
    password varchar(200) not null,
	address varchar(1000) character set utf8 default '',
    phone_number char(20) NOT NULL default '',
    gender char(10) character set utf8 default 'unknown',
    birthday date,
...
-- VALUES (1, "Cat", "Kitty", "kittycat", "cat@gmail.com", "123456", "Hà Nội");

-- drop table if EXISTS product;
create table products(
	product_id int auto_increment primary key,
	product_name varchar(40) character set utf8 default 'unknown',
	product_type varchar(100) character set utf8,
	product_avatar varchar(500) character set utf8,
...
create table orders(
    ...
    user_id int not null,
    user_name varchar(100) character set utf8 default "unkown",
    email varchar(100) character set utf8 default "unkown",
    address varchar(1000) character set utf8 not null,
    phone_number char(20) NOT NULL,
    total DECIMAL(10, 2) default 0 not null,
    note varchar(10000) character set utf8 default "",
...
-- 	name_product varchar(40) character set utf8 NOT NULL ,
-- 	source_product varchar(40) character set utf8 default 'unknown',
